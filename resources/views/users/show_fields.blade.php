...
<script type="text/javascript">
        ...
        function createTRTools(element,index) {
            return $(" <tr><th class='col-2'  scope='row'>"+index+"</th><td class='col-6' >"+element.name+"</td><td class='col-2' ><button onclick='onDelete("+element.id+")' type='button' class='btn btn-danger'>Delete</button></td></tr>");
        }
        ...
        function createTRTrainings(element,index) {
            return $(" <tr><th class='col-2'  scope='row'>"+index+"</th><td class='col-6' >"+element.name+"</td><td class='col-2' ><button onclick='onDeleteTraining("+element.id+")' type='button' class='btn btn-danger'>Delete</button></td></tr>");
        }
        ...
        function createTRGools(element,index) {
            return $(" <tr><th class='col-2'  scope='row'>"+index+
                ...
                "</td><td class='col-2' ><button onclick='onDeleteGool("+element.id+")' type='button' class='btn btn-danger'>Delete</button></td></tr>");
        }
</script>
@endpush
